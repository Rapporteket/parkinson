...
params:
  ...
  bins: 5
title: Samlerapport
subtitle: en eksempelrapport fra parkinson
author: Rapporteket
userFullName: Tore Tester
registryName: SKDE
reglogo: '`r system.file("logo.png", package = "parkinson")`'
regtext: '`r readLines(system.file("shortDescription.txt", package = "parkinson"))`'
...
f <- parkinson::makeHist(df = mtcars, var = params$var, bins = params$bins, makeTable = FALSE)
```
